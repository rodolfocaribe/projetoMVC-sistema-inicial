...
insert into professores (nome) VALUES ('Professor Girafales');
insert into professores (nome) VALUES ('Professor Pardal');
insert into professores (nome) VALUES ('Professor Raimundo');